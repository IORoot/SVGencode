    ...
    render() {
        ...
        return (
            <div className={this.props.className + " relative"}>
                ...
                <div className="w-4 h-4 fill-slate-300 absolute right-0 top-5 hover:fill-blue-500 active:fill-red-500" role="button" tabIndex="0" onClick={() => {navigator.clipboard.writeText(content)}}>
