      ...
      <main>
        ...
        <div className="w-full min-h-screen flex sm:flex-row">
          ...
          <div role="main" className="w-4/6 p-4 grid grid-cols-4 gap-6 auto-rows-auto mb-auto">
            ...
            <h2 className="col-span-4 text-xl text-blue-900 border-b-2 border-blue-900">URL-Encoding</h2>
            ...
            <h2 className="col-span-4 text-xl text-blue-900 border-b-2 border-blue-900">Base64 Encoded</h2>
            ...
            <h2 className="col-span-4 text-xl text-blue-900 border-b-2 border-blue-900">Alterations</h2>
            ...
            <h2 className="col-span-4 text-xl text-blue-900 border-b-2 border-blue-900">Other Encodings</h2>
